...
namespace SpreadShare.Tests.ExchangeServices.DataProviderTests
{
    public class AverageTrueRangeTests : BaseProviderTests
    {
            ...
            : base(outputHelper)
        {
            ...
            property.SetValue(_data, new DataProviderCandlesImplementation(LoggerFactory, comms));
        }
        ...
        internal class DataProviderCandlesImplementation : AbstractDataProvider
        {
            public DataProviderCandlesImplementation(ILoggerFactory loggerFactory, ExchangeCommunications exchangeCommunications)
